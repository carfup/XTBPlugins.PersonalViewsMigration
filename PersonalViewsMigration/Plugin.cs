...
namespace Carfup.XTBPlugins.PersonalViewsMigration
{
    [Export(typeof(IXrmToolBoxPlugin)),
       ExportMetadata("Name", "Personal user views migration"),
       ExportMetadata("Description", "This tool will allow you to reassign or copy personal views from one user to another. This is really useful when someone left a company and forgot to migrate his own views to somebody else."),
    ...
    public class Plugin : PluginBase
    {
        ...
        {
            return new PersonalViewsMigration();
        }
    }
}
